...
pub const DEFAULT_OUTLINE_RULES: &str = concat!(
  ...
  "\n---\n",
  include_str!("default_rules/bash.yml"),
  "\n---\n",
  include_str!("default_rules/lua.yml"),
  "\n---\n",
  include_str!("default_rules/scala.yml"),
  "\n---\n",
  include_str!("default_rules/elixir.yml"),
  "\n---\n",
  include_str!("default_rules/haskell.yml"),
  "\n---\n",
  include_str!("default_rules/dart.yml"),
  "\n---\n",
  include_str!("default_rules/solidity.yml"),
  "\n---\n",
  include_str!("default_rules/hcl.yml"),
  "\n---\n",
  include_str!("default_rules/markdown.yml"),
  "\n---\n",
  include_str!("default_rules/nix.yml"),
  "\n---\n",
  include_str!("default_rules/json.yml"),
  "\n---\n",
  include_str!("default_rules/toml.yml"),
  "\n---\n",
  include_str!("default_rules/dockerfile.yml"),
  "\n---\n",
  include_str!("default_rules/make.yml"),
  "\n---\n",
  include_str!("default_rules/cmake.yml"),
  "\n---\n",
  include_str!("default_rules/ini.yml"),
  "\n---\n",
  include_str!("default_rules/xml.yml"),
  "\n---\n",
  include_str!("default_rules/proto.yml"),
  "\n---\n",
  include_str!("default_rules/graphql.yml"),
  "\n---\n",
  include_str!("default_rules/sql.yml"),
  "\n---\n",
  include_str!("default_rules/objectivec.yml"),
  "\n---\n",
  include_str!("default_rules/perl.yml"),
  "\n---\n",
  include_str!("default_rules/zig.yml"),
  "\n---\n",
  include_str!("default_rules/erlang.yml"),
  "\n---\n",
  include_str!("default_rules/ocaml.yml"),
  "\n---\n",
  include_str!("default_rules/r.yml"),
  "\n---\n",
  include_str!("default_rules/julia.yml"),
  "\n---\n",
  include_str!("default_rules/powershell.yml"),
  "\n---\n",
