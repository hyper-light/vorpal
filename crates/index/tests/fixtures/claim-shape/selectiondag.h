// Vendored regression fixture from llvm-project (llvm/include/llvm/CodeGen/SelectionDAG.h,
// commit d37814473, Apache-2.0 WITH LLVM-exception). This exact parse once drove
// tree-sitter-cpp through an exact-reserved children array that ts_subtree_new_node
// claimed un-class-shaped — ts_children_free_node then over-binned it (heap corruption,
// SIGSEGV). See vendor/tree-sitter/src/children_cache.h::ts_children_node_block_ok.
